# -*- coding: utf-8 -*-
"""
Created on Fri Mar 13 11:00:45 2020
...
from transformers import XLNetForQuestionAnswering, XLNetConfig,XLNetTokenizer
# 随机种子
...
def train():
    ...
    model = XLNetForQuestionAnswering.from_pretrained('xlnet_model.ckpt.index', from_tf=True, config=config)
    device = args.device
    model.to(device)
    ...
    optimizer = adabound.AdaBound(optimizer_grouped_parameters,lr=1e-3,final_lr=0.1)
    # 准备数据
    data = Dureader()
